          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-foreground max-w-3xl mx-auto">
                Professional speech and language treatment for children and
                adults. Our certified speech therapists provide personalized
                treatment plans to help you achieve clear and confident
                communication.
              </p>
            </div>
