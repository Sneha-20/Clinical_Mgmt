          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-lg text-foreground leading-relaxed mb-4">
                  ...
                  speech therapy services. Our mission is to improve
                  communication and hearing health for every patient who walks
                  through our doors.
                </p>
                <p className="text-lg text-foreground leading-relaxed">
                  We believe that clear communication is fundamental to a
                  fulfilling life. Through cutting-edge technology and
                  compassionate care, we help our patients rediscover the joy of
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-foreground">
                    Highly qualified audiologists and speech therapists with
            ...
            <div className="bg-primary text-white rounded-lg p-12 text-center">
              ...
              <p className="text-lg lead-relaxed max-w-3xl mx-auto">
                Founded with a vision to revolutionize hearing healthcare and
                speech therapy, Navjeevan has grown to become a trusted name in
                the region. Over the years, we've helped thousands of patients
                restore their hearing and improve their communication abilities.
              </p>
            </div>
                ...
                {staff.map((doctor, index) => (
                  <div key={index} className="px-4">
                    <div className="bg-white rounded-lg shadow-md p-6 text-center">
                      ...
                      <p className="text-foreground">{doctor.specialization}</p>
                    </div>
                  </div>
                ))}
              </Slider>
